# Shortcut SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShortcutSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShortcutSDK(...) and ShortcutSDK.test(...) become
#      ShortcutSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shortcut_sdk"
_SDK_CLASS = "ShortcutSDK"
...
_ENTITIES = {
    ...
    "Epic": "epic",
    "EpicPaginatedResult": "epic_paginated_result",
    "EpicUnlinkProductboard": "epic_unlink_productboard",
    "EpicWorkflow": "epic_workflow",
    "Group": "group",
    "Health": "health",
    "History": "history",
    "Iteration": "iteration",
    ...
    "StorySlim": "story_slim",
    "Task": "task",
    "ThreadedComment": "threaded_comment",
