...
class TestCategoryEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        category_ref01_data = helpers.to_map(category_ref01_ent.create(category_ref01_data, None))
        ...
        category_ref01_resdata_up0 = helpers.to_map(category_ref01_ent.update(category_ref01_data_up0_up, None))
