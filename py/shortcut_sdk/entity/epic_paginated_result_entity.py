...
class EpicPaginatedResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EpicPaginatedResultEntity(self._client, opts)
    ...
    def data_get(self) -> EpicPaginatedResult:
    ...
    def match_get(self) -> EpicPaginatedResult:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EpicPaginatedResult]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EpicPaginatedResult().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
