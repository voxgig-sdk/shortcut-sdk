...
class EpicWorkflowEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EpicWorkflowEntity(self._client, opts)
    ...
    def data_get(self) -> EpicWorkflow:
    ...
    def match_get(self) -> EpicWorkflow:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EpicWorkflow]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EpicWorkflow().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
