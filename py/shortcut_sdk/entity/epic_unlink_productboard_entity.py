...
class EpicUnlinkProductboardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EpicUnlinkProductboardEntity(self._client, opts)
    ...
    def data_get(self) -> EpicUnlinkProductboard:
    ...
    def match_get(self) -> EpicUnlinkProductboard:
    ...
    def create(self, reqdata: EpicUnlinkProductboardCreateData, ctrl=None) -> EpicUnlinkProductboard:
        utility = self._utility
