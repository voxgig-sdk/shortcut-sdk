...
exports.ObjectifEntity = void 0;
const ShortcutEntityBase_1 = require("../ShortcutEntityBase");
// TODO: needs Entity superclass
class ObjectifEntity extends ShortcutEntityBase_1.ShortcutEntityBase {
    ...
    make() {
        return new ObjectifEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<ObjectifEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.ObjectifEntity = ObjectifEntity;
//# sourceMappingURL=ObjectifEntity.js.map