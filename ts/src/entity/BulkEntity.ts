...
class BulkEntity extends ShortcutEntityBase<Bulk> {
  ...
  async remove(
    this: any, reqmatch?: BulkRemoveMatch, ctrl?: Control,
  ): Promise<BulkEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BulkEntity> return stays clean under strict null checks.
