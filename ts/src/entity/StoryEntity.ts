...
class StoryEntity extends ShortcutEntityBase<Story> {
  ...
  async load(this: any, reqmatch?: StoryLoadMatch, ctrl?: Control): Promise<StoryEntity> {
  ...
  async create(this: any, reqdata?: StoryCreateData, ctrl?: Control): Promise<StoryEntity> {
  ...
  async update(this: any, reqdata?: StoryUpdateData, ctrl?: Control): Promise<StoryEntity> {
  ...
  async remove(
    this: any, reqmatch?: StoryRemoveMatch, ctrl?: Control,
  ): Promise<StoryEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<StoryEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
