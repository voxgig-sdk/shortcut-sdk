...
class CategoryEntity extends ShortcutEntityBase<Category> {
  ...
  async create(this: any, reqdata?: CategoryCreateData, ctrl?: Control): Promise<CategoryEntity> {
  ...
  async update(this: any, reqdata?: CategoryUpdateData, ctrl?: Control): Promise<CategoryEntity> {
  ...
  async remove(
    this: any, reqmatch?: CategoryRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CategoryEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
