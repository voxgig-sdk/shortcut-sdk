...
describe('KeyResultDirect', async () => {
  ...
  test('direct-load-key_result', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-key_result', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['SHORTCUT_TEST_KEY_RESULT_ENTID']
