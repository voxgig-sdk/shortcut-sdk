...
function envOverride(m) {
    if ('TRUE' === process.env.SHORTCUT_TEST_LIVE ||
        'TRUE' === process.env.SHORTCUT_TEST_OVERRIDE) {
    ...
    m.SHORTCUT_TEST_EXPLAIN = process.env.SHORTCUT_TEST_EXPLAIN || m.SHORTCUT_TEST_EXPLAIN;
    return m;
}
