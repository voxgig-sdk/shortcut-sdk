...
const TEST_SEED = { "entity": { "bulk": { "test01": { "id": "test01" } }, "category": { "test01": { "id": "test01" } }, "comment": { "test01": { "id": "test01" } }, "custom_field": { "test01": { "id": "test01" } }, "disable": { "test01": { "id": "test01" } }, "doc_slim": { "test01": { "id": "test01" } }, "enable": { "test01": { "id": "test01" } }, "entity_template": { "test01": { "id": "test01" } }, "epic": { "test01": { "id": "test01" } }, "epic_paginated_result": { "test01": { "id": "test01" } }, "epic_unlink_productboard": { "test01": { "id": "test01" } }, "epic_workflow": { "test01": { "id": "test01" } }, "group": { "test01": { "id": "test01" } }, "health": { "test01": { "id": "test01" } }, "history": { "test01": { "id": "test01" } }, "iteration": { "test01": { "id": "test01" } }, "key_result": { "test01": { "id": "test01" } }, "label": { "test01": { "id": "test01" } }, "linked_file": { "test01": { "id": "test01" } }, "member": { "test01": { "id": "test01" } }, "milestone": { "test01": { "id": "test01" } }, "objectif": { "test01": { "id": "test01" } }, "objective": { "test01": { "id": "test01" } }, "project": { "test01": { "id": "test01" } }, "repository": { "test01": { "id": "test01" } }, "search": { "test01": { "id": "test01" } }, "story": { "test01": { "id": "test01" } }, "story_comment": { "test01": { "id": "test01" } }, "story_link": { "test01": { "id": "test01" } }, "story_reaction": { "test01": { "id": "test01" } }, "story_slim": { "test01": { "id": "test01" } }, "task": { "test01": { "id": "test01" } }, "threaded_comment": { "test01": { "id": "test01" } }, "uploaded_file": { "test01": { "id": "test01" } }, "webhook": { "test01": { "id": "test01" } }, "workflow": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+ShortcutSDK\b/.test(code) ||
        /\bShortcutSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+ShortcutSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/ShortcutSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
