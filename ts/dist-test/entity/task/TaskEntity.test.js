...
(0, node_test_1.describe)('TaskEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(task_ref01_resdata_up0.id === task_ref01_data_up0.id);
        (0, node_assert_1.default)(task_ref01_resdata_up0[task_ref01_markdef_up0.name] === task_ref01_markdef_up0.value);
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['task01', 'task02', 'task03', 'story01', 'story02', 'story03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
