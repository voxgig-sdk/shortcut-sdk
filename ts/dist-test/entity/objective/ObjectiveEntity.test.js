...
(0, node_test_1.describe)('ObjectiveEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'objective.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != objective_ref01_data.id);
        // LIST
        const objective_ref01_match = {};
        const objective_ref01_list = (await objective_ref01_ent.list(objective_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(objective_ref01_list, { id: objective_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(objective_ref01_resdata_up0.id === objective_ref01_data_up0.id);
        (0, node_assert_1.default)(objective_ref01_resdata_up0[objective_ref01_markdef_up0.name] === objective_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(objective_ref01_data_dt0.id === objective_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/objective/ObjectiveTestData.json');
    ...
    let idmap = transform(['objective01', 'objective02', 'objective03', 'objectif01', 'objectif02', 'objectif03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ObjectiveEntity.test.js.map