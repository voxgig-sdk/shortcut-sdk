...
(0, node_test_1.describe)('StorySlimEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'story_slim.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != story_slim_ref01_data);
        // UPDATE
        ...
        (0, node_assert_1.default)(null != story_slim_ref01_resdata_up0);
        (0, node_assert_1.default)(story_slim_ref01_resdata_up0[story_slim_ref01_markdef_up0.name] === story_slim_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/story_slim/StorySlimTestData.json');
    ...
    let idmap = transform(['story_slim01', 'story_slim02', 'story_slim03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHORTCUT_TEST_STORY_SLIM_ENTID'];
...
//# sourceMappingURL=StorySlimEntity.test.js.map