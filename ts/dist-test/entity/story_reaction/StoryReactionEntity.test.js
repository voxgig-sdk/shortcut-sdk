...
(0, node_test_1.describe)('StoryReactionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != story_reaction_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/story_reaction/StoryReactionTestData.json');
    ...
    let idmap = transform(['story_reaction01', 'story_reaction02', 'story_reaction03', 'story01', 'story02', 'story03', 'comment01', 'comment02', 'comment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=StoryReactionEntity.test.js.map