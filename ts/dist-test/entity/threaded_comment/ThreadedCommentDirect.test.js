...
(0, node_test_1.describe)('ThreadedCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-threaded_comment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-threaded_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["epic01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-threaded_comment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-threaded_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["epic01"]))
            return;
        const { client, calls } = setup;
...
//# sourceMappingURL=ThreadedCommentDirect.test.js.map