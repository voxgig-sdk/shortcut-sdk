...
(0, node_test_1.describe)('ThreadedCommentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'threaded_comment.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != threaded_comment_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(threaded_comment_ref01_list, { id: threaded_comment_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(threaded_comment_ref01_resdata_up0.id === threaded_comment_ref01_data_up0.id);
        (0, node_assert_1.default)(threaded_comment_ref01_resdata_up0[threaded_comment_ref01_markdef_up0.name] === threaded_comment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(threaded_comment_ref01_data_dt0.id === threaded_comment_ref01_data.id);
        // REMOVE
        const threaded_comment_ref01_match_rm0 = { id: threaded_comment_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(threaded_comment_ref01_list_rt0, { id: threaded_comment_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/threaded_comment/ThreadedCommentTestData.json');
    ...
    let idmap = transform(['threaded_comment01', 'threaded_comment02', 'threaded_comment03', 'epic01', 'epic02', 'epic03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ThreadedCommentEntity.test.js.map