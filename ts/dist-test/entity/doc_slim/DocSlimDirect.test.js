...
(0, node_test_1.describe)('DocSlimDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-doc_slim', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-doc_slim', setup.live))
            return;
...
//# sourceMappingURL=DocSlimDirect.test.js.map