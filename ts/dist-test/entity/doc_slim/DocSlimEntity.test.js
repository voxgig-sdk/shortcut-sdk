...
(0, node_test_1.describe)('DocSlimEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'doc_slim.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != doc_slim_ref01_data.id);
        // LIST
        const doc_slim_ref01_match = {};
        const doc_slim_ref01_list = (await doc_slim_ref01_ent.list(doc_slim_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(doc_slim_ref01_list, { id: doc_slim_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/doc_slim/DocSlimTestData.json');
    ...
    let idmap = transform(['doc_slim01', 'doc_slim02', 'doc_slim03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DocSlimEntity.test.js.map