...
(0, node_test_1.describe)('EpicUnlinkProductboardEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'epic_unlink_productboard.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/epic_unlink_productboard/EpicUnlinkProductboardTestData.json');
    ...
    let idmap = transform(['epic_unlink_productboard01', 'epic_unlink_productboard02', 'epic_unlink_productboard03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHORTCUT_TEST_EPIC_UNLINK_PRODUCTBOARD_ENTID'];
...
//# sourceMappingURL=EpicUnlinkProductboardEntity.test.js.map