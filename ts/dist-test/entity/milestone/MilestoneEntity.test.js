...
(0, node_test_1.describe)('MilestoneEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // REMOVE
        const milestone_ref01_match_rm0 = { id: milestone_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(milestone_ref01_list_rt0, { id: milestone_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['milestone01', 'milestone02', 'milestone03', 'category01', 'category02', 'category03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
