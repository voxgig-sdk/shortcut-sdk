...
(0, node_test_1.describe)('EpicWorkflowDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-epic_workflow', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-epic_workflow', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SHORTCUT_TEST_EPIC_WORKFLOW_ENTID'];
...
//# sourceMappingURL=EpicWorkflowDirect.test.js.map