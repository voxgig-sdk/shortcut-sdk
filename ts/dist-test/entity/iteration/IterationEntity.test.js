...
(0, node_test_1.describe)('IterationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'iteration.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != iteration_ref01_data.id);
        // LIST
        const iteration_ref01_match = {};
        const iteration_ref01_list = (await iteration_ref01_ent.list(iteration_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(iteration_ref01_list, { id: iteration_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(iteration_ref01_resdata_up0.id === iteration_ref01_data_up0.id);
        (0, node_assert_1.default)(iteration_ref01_resdata_up0[iteration_ref01_markdef_up0.name] === iteration_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(iteration_ref01_data_dt0.id === iteration_ref01_data.id);
        // REMOVE
        const iteration_ref01_match_rm0 = { id: iteration_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(iteration_ref01_list_rt0, { id: iteration_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/iteration/IterationTestData.json');
    ...
    let idmap = transform(['iteration01', 'iteration02', 'iteration03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=IterationEntity.test.js.map