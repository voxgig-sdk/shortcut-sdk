...
(0, node_test_1.describe)('StoryCommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-story_comment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-story_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["story01"]))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['story_comment01'],
                },
            });
    ...
    (0, node_test_1.test)('direct-list-story_comment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-story_comment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["story_comment01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SHORTCUT_TEST_STORY_COMMENT_ENTID'];
...
//# sourceMappingURL=StoryCommentDirect.test.js.map