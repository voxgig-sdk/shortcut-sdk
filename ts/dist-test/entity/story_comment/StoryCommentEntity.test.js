...
(0, node_test_1.describe)('StoryCommentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'story_comment.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != story_comment_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(story_comment_ref01_list, { id: story_comment_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(story_comment_ref01_resdata_up0.id === story_comment_ref01_data_up0.id);
        (0, node_assert_1.default)(story_comment_ref01_resdata_up0[story_comment_ref01_markdef_up0.name] === story_comment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(story_comment_ref01_data_dt0.id === story_comment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/story_comment/StoryCommentTestData.json');
    ...
    let idmap = transform(['story_comment01', 'story_comment02', 'story_comment03', 'story01', 'story02', 'story03', 'story01', 'story02', 'story03', 'comment01', 'comment02', 'comment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=StoryCommentEntity.test.js.map