...
(0, node_test_1.describe)('KeyResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-key_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-key_result', setup.live))
            return;
...
//# sourceMappingURL=KeyResultDirect.test.js.map