...
(0, node_test_1.describe)('UploadedFileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-uploaded_file', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-uploaded_file', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-uploaded_file', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-uploaded_file', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SHORTCUT_TEST_UPLOADED_FILE_ENTID'];
...
//# sourceMappingURL=UploadedFileDirect.test.js.map