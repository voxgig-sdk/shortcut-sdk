...
(0, node_test_1.describe)('EpicPaginatedResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'epic_paginated_result.' + op, live))
                return;
        }
        ...
        let epic_paginated_result_ref01_data = Object.values(setup.data.existing.epic_paginated_result)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/epic_paginated_result/EpicPaginatedResultTestData.json');
    ...
    let idmap = transform(['epic_paginated_result01', 'epic_paginated_result02', 'epic_paginated_result03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHORTCUT_TEST_EPIC_PAGINATED_RESULT_ENTID'];
...
//# sourceMappingURL=EpicPaginatedResultEntity.test.js.map