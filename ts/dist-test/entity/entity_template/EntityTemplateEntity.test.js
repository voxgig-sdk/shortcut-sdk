...
(0, node_test_1.describe)('EntityTemplateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'entity_template.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != entity_template_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(entity_template_ref01_list, { id: entity_template_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(entity_template_ref01_resdata_up0.id === entity_template_ref01_data_up0.id);
        (0, node_assert_1.default)(entity_template_ref01_resdata_up0[entity_template_ref01_markdef_up0.name] === entity_template_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(entity_template_ref01_data_dt0.id === entity_template_ref01_data.id);
        // REMOVE
        const entity_template_ref01_match_rm0 = { id: entity_template_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(entity_template_ref01_list_rt0, { id: entity_template_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/entity_template/EntityTemplateTestData.json');
    ...
    let idmap = transform(['entity_template01', 'entity_template02', 'entity_template03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EntityTemplateEntity.test.js.map