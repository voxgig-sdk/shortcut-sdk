...
(0, node_test_1.describe)('EntityTemplateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-entity_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entity_template', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-entity_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-entity_template', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SHORTCUT_TEST_ENTITY_TEMPLATE_ENTID'];
...
//# sourceMappingURL=EntityTemplateDirect.test.js.map