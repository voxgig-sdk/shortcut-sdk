...
(0, node_test_1.describe)('EpicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'epic.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != epic_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(epic_ref01_list, { id: epic_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(epic_ref01_resdata_up0.id === epic_ref01_data_up0.id);
        (0, node_assert_1.default)(epic_ref01_resdata_up0[epic_ref01_markdef_up0.name] === epic_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(epic_ref01_data_dt0.id === epic_ref01_data.id);
        // REMOVE
        const epic_ref01_match_rm0 = { id: epic_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(epic_ref01_list_rt0, { id: epic_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/epic/EpicTestData.json');
    ...
    let idmap = transform(['epic01', 'epic02', 'epic03', 'label01', 'label02', 'label03', 'milestone01', 'milestone02', 'milestone03', 'objectif01', 'objectif02', 'objectif03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHORTCUT_TEST_EPIC_ENTID'];
...
//# sourceMappingURL=EpicEntity.test.js.map