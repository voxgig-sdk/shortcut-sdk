...
function basicSetup(extra) {
    ...
    let idmap = transform(['history01', 'history02', 'history03', 'story01', 'story02', 'story03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHORTCUT_TEST_HISTORY_ENTID'];
    ...
    idmap = env['SHORTCUT_TEST_HISTORY_ENTID'];
