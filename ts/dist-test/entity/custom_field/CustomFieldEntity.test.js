...
function basicSetup(extra) {
    ...
    let idmap = transform(['custom_field01', 'custom_field02', 'custom_field03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
