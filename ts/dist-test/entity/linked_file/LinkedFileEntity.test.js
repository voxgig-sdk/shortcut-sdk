...
(0, node_test_1.describe)('LinkedFileEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != linked_file_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(linked_file_ref01_list, { id: linked_file_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(linked_file_ref01_resdata_up0.id === linked_file_ref01_data_up0.id);
        (0, node_assert_1.default)(linked_file_ref01_resdata_up0[linked_file_ref01_markdef_up0.name] === linked_file_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(linked_file_ref01_data_dt0.id === linked_file_ref01_data.id);
        // REMOVE
        const linked_file_ref01_match_rm0 = { id: linked_file_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(linked_file_ref01_list_rt0, { id: linked_file_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/linked_file/LinkedFileTestData.json');
    ...
    let idmap = transform(['linked_file01', 'linked_file02', 'linked_file03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=LinkedFileEntity.test.js.map