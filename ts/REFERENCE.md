...
| `story_contents` | `Record<string, any>` | Yes |  |
...
| `description` | `string` | Yes |  |
| `display_icon` | `Record<string, any>` | Yes |  |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `current_observed_value` | `Record<string, any>` | Yes |  |
| `current_target_value` | `Record<string, any>` | Yes |  |
| `id` | `string` | Yes |  |
| `initial_observed_value` | `Record<string, any>` | Yes |  |
| `name` | `string` | Yes |  |
| `objective_id` | `number` | Yes |  |
| `observed_value` | `Record<string, any>` | No |  |
| `progress` | `number` | Yes |  |
| `target_value` | `Record<string, any>` | No |  |
| `type` | `string` | Yes |  |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `epics` | `Record<string, any>` | Yes |  |
| `iterations` | `Record<string, any>` | Yes |  |
| `milestones` | `Record<string, any>` | Yes |  |
| `stories` | `Record<string, any>` | Yes |  |
...
| `sub_tasks` | `any[]` | No |  |
| `synced_item` | `Record<string, any>` | Yes |  |
| `task_ids` | `any[]` | No |  |
| `tasks` | `any[]` | Yes |  |
| `updated_at` | `string` | Yes |  |
| `workflow_id` | `number` | Yes |  |
