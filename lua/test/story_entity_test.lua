...
describe("StoryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    local story_ref01_resdata_up0 = helpers.to_map(story_ref01_resdata_up0_result)
    ...
    assert.is_nil(err)
    local story_ref01_data_dt0_load_result = helpers.to_map(story_ref01_data_dt0_loaded)
