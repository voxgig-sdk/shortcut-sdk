...
describe("LabelEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_LABEL_ENTID JSON to run live")
      return
    end
    ...
    local label_ref01_markdef_up0_name = "app_url"
    ...
    -- LIST
    local label_ref01_match_rt0 = {}

    local label_ref01_list_rt0_result, err = label_ref01_ent:list(label_ref01_match_rt0, nil)
    assert.is_nil(err)
    assert.is_table(label_ref01_list_rt0_result)
...
function label_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORTCUT_TEST_LABEL_ENTID")
