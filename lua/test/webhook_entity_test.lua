...
describe("WebhookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_WEBHOOK_ENTID JSON to run live")
      return
    end
...
function webhook_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORTCUT_TEST_WEBHOOK_ENTID")
