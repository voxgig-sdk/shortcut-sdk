...
describe("DocSlimDirect", function()
  it("should direct-list-doc_slim", function()
    local setup = doc_slim_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-doc_slim", setup.live and "live" or "unit")
...
function doc_slim_direct_setup(mockres)
