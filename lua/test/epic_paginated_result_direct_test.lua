-- EpicPaginatedResult direct test
...
describe("EpicPaginatedResultDirect", function()
  it("should direct-list-epic_paginated_result", function()
    local setup = epic_paginated_result_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-epic_paginated_result", setup.live and "live" or "unit")
...
function epic_paginated_result_direct_setup(mockres)
