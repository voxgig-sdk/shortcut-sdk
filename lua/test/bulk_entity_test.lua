...
describe("BulkEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_BULK_ENTID JSON to run live")
      return
    end
...
function bulk_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORTCUT_TEST_BULK_ENTID")
