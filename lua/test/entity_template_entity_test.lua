...
describe("EntityTemplateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    entity_template_ref01_data = helpers.to_map(type(entity_template_ref01_data_result) == 'table' and entity_template_ref01_data_result.data_get and entity_template_ref01_data_result:data_get() or entity_template_ref01_data_result)
    ...
    assert.is_nil(err)
    local entity_template_ref01_resdata_up0 = helpers.to_map(type(entity_template_ref01_resdata_up0_result) == 'table' and entity_template_ref01_resdata_up0_result.data_get and entity_template_ref01_resdata_up0_result:data_get() or entity_template_ref01_resdata_up0_result)
    ...
    assert.is_nil(err)
    local entity_template_ref01_data_dt0_load_result = helpers.to_map(type(entity_template_ref01_data_dt0_loaded) == 'table' and entity_template_ref01_data_dt0_loaded.data_get and entity_template_ref01_data_dt0_loaded:data_get() or entity_template_ref01_data_dt0_loaded)
