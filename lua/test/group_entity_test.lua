...
describe("GroupEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_GROUP_ENTID JSON to run live")
      return
    end
    ...
    local group_ref01_markdef_up0_name = "app_url"
...
function group_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORTCUT_TEST_GROUP_ENTID")
