...
describe("EpicWorkflowDirect", function()
  it("should direct-list-epic_workflow", function()
    local setup = epic_workflow_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-epic_workflow", setup.live and "live" or "unit")
...
function epic_workflow_direct_setup(mockres)
