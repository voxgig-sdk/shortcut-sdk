...
describe("MemberEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_MEMBER_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local member_ref01_data_dt0_load_result = helpers.to_map(member_ref01_data_dt0_loaded)
...
function member_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORTCUT_TEST_MEMBER_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["SHORTCUT_TEST_MEMBER_ENTID"])
