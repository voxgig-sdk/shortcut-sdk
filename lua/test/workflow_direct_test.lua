...
describe("WorkflowDirect", function()
  it("should direct-list-workflow", function()
    local setup = workflow_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-workflow", setup.live and "live" or "unit")
