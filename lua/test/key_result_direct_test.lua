...
describe("KeyResultDirect", function()
  it("should direct-load-key_result", function()
    local setup = key_result_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-key_result", setup.live and "live" or "unit")
...
function key_result_direct_setup(mockres)
