...
describe("StoryLinkDirect", function()
  it("should direct-load-story_link", function()
    local setup = story_link_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-story_link", setup.live and "live" or "unit")
...
function story_link_direct_setup(mockres)
