...
local ThreadedCommentEntity = {}
ThreadedCommentEntity.__index = ThreadedCommentEntity


function ThreadedCommentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThreadedCommentEntity)
  self._name = "threaded_comment"
  self._client = client
...
function ThreadedCommentEntity:get_name()
  return self._name
end


function ThreadedCommentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ThreadedCommentEntity.new(self._client, opts)
end
...
function ThreadedCommentEntity:mark_deleted()
  self._deleted = true
end


function ThreadedCommentEntity:deleted()
  return true == self._deleted
end


function ThreadedCommentEntity:data_set(args)
  if args ~= nil then
...
function ThreadedCommentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThreadedCommentEntity:match_set(args)
  if args ~= nil then
...
function ThreadedCommentEntity:match_get()
...
function ThreadedCommentEntity:stream(action, args, callopts)
...
---@param reqmatch ThreadedCommentLoadMatch
---@param ctrl? table
---@return ThreadedComment
---@return string? err
function ThreadedCommentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ThreadedCommentListMatch
---@param ctrl? table
---@return ThreadedComment[]
---@return string? err
function ThreadedCommentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ThreadedCommentCreateData
---@param ctrl? table
---@return ThreadedComment
---@return string? err
function ThreadedCommentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ThreadedCommentUpdateData
---@param ctrl? table
---@return ThreadedComment
---@return string? err
function ThreadedCommentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ThreadedCommentRemoveMatch
---@param ctrl? table
---@return ThreadedComment
---@return string? err
function ThreadedCommentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ThreadedCommentEntity:_run_op(ctx, post_done)
  local utility = self._utility
