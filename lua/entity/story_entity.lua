...
---@param reqdata StoryCreateData
---@param ctrl? table
---@return Story
---@return string? err
function StoryEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata StoryUpdateData
---@param ctrl? table
---@return Story
---@return string? err
function StoryEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch StoryRemoveMatch
---@param ctrl? table
---@return Story
---@return string? err
function StoryEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
