...
local DocSlimEntity = {}
DocSlimEntity.__index = DocSlimEntity


function DocSlimEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DocSlimEntity)
  self._name = "doc_slim"
  self._client = client
...
function DocSlimEntity:get_name()
  return self._name
end


function DocSlimEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DocSlimEntity.new(self._client, opts)
end
...
function DocSlimEntity:mark_deleted()
  self._deleted = true
end


function DocSlimEntity:deleted()
  return true == self._deleted
end


function DocSlimEntity:data_set(args)
  if args ~= nil then
...
function DocSlimEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DocSlimEntity:match_set(args)
  if args ~= nil then
...
function DocSlimEntity:match_get()
...
function DocSlimEntity:stream(action, args, callopts)
...
---@param reqmatch DocSlimListMatch
---@param ctrl? table
---@return DocSlim[]
---@return string? err
function DocSlimEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DocSlimCreateData
---@param ctrl? table
---@return DocSlim
---@return string? err
function DocSlimEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DocSlimEntity:_run_op(ctx, post_done)
  local utility = self._utility
