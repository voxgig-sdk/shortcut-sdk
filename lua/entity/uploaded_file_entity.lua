...
local UploadedFileEntity = {}
UploadedFileEntity.__index = UploadedFileEntity


function UploadedFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UploadedFileEntity)
  self._name = "uploaded_file"
  self._client = client
...
function UploadedFileEntity:get_name()
  return self._name
end


function UploadedFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UploadedFileEntity.new(self._client, opts)
end
...
function UploadedFileEntity:mark_deleted()
  self._deleted = true
end


function UploadedFileEntity:deleted()
  return true == self._deleted
end


function UploadedFileEntity:data_set(args)
  if args ~= nil then
...
function UploadedFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UploadedFileEntity:match_set(args)
  if args ~= nil then
...
function UploadedFileEntity:match_get()
...
function UploadedFileEntity:stream(action, args, callopts)
...
---@param reqmatch UploadedFileLoadMatch
---@param ctrl? table
---@return UploadedFile
---@return string? err
function UploadedFileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch UploadedFileListMatch
---@param ctrl? table
---@return UploadedFile[]
---@return string? err
function UploadedFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata UploadedFileCreateData
---@param ctrl? table
---@return UploadedFile
---@return string? err
function UploadedFileEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata UploadedFileUpdateData
---@param ctrl? table
---@return UploadedFile
---@return string? err
function UploadedFileEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch UploadedFileRemoveMatch
---@param ctrl? table
---@return UploadedFile
---@return string? err
function UploadedFileEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function UploadedFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
