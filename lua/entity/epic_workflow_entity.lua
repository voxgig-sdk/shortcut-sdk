...
local EpicWorkflowEntity = {}
EpicWorkflowEntity.__index = EpicWorkflowEntity


function EpicWorkflowEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EpicWorkflowEntity)
  self._name = "epic_workflow"
  self._client = client
...
function EpicWorkflowEntity:get_name()
  return self._name
end


function EpicWorkflowEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EpicWorkflowEntity.new(self._client, opts)
end
...
function EpicWorkflowEntity:mark_deleted()
  self._deleted = true
end


function EpicWorkflowEntity:deleted()
  return true == self._deleted
end


function EpicWorkflowEntity:data_set(args)
  if args ~= nil then
...
function EpicWorkflowEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EpicWorkflowEntity:match_set(args)
  if args ~= nil then
...
function EpicWorkflowEntity:match_get()
...
function EpicWorkflowEntity:stream(action, args, callopts)
...
---@param reqmatch EpicWorkflowListMatch
---@param ctrl? table
---@return EpicWorkflow[]
---@return string? err
function EpicWorkflowEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EpicWorkflowEntity:_run_op(ctx, post_done)
  local utility = self._utility
