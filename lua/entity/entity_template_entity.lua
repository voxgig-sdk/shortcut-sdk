...
local EntityTemplateEntity = {}
EntityTemplateEntity.__index = EntityTemplateEntity


function EntityTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EntityTemplateEntity)
  self._name = "entity_template"
  self._client = client
...
function EntityTemplateEntity:get_name()
  return self._name
end


function EntityTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EntityTemplateEntity.new(self._client, opts)
end
...
function EntityTemplateEntity:mark_deleted()
  self._deleted = true
end


function EntityTemplateEntity:deleted()
  return true == self._deleted
end


function EntityTemplateEntity:data_set(args)
  if args ~= nil then
...
function EntityTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EntityTemplateEntity:match_set(args)
  if args ~= nil then
...
function EntityTemplateEntity:match_get()
...
function EntityTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch EntityTemplateLoadMatch
---@param ctrl? table
---@return EntityTemplate
---@return string? err
function EntityTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EntityTemplateListMatch
---@param ctrl? table
---@return EntityTemplate[]
---@return string? err
function EntityTemplateEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata EntityTemplateCreateData
---@param ctrl? table
---@return EntityTemplate
---@return string? err
function EntityTemplateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EntityTemplateUpdateData
---@param ctrl? table
---@return EntityTemplate
---@return string? err
function EntityTemplateEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch EntityTemplateRemoveMatch
---@param ctrl? table
---@return EntityTemplate
---@return string? err
function EntityTemplateEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function EntityTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
