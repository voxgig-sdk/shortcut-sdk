...
local LinkedFileEntity = {}
LinkedFileEntity.__index = LinkedFileEntity


function LinkedFileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LinkedFileEntity)
  self._name = "linked_file"
  self._client = client
...
function LinkedFileEntity:get_name()
  return self._name
end


function LinkedFileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LinkedFileEntity.new(self._client, opts)
end
...
function LinkedFileEntity:mark_deleted()
  self._deleted = true
end


function LinkedFileEntity:deleted()
  return true == self._deleted
end


function LinkedFileEntity:data_set(args)
  if args ~= nil then
...
function LinkedFileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LinkedFileEntity:match_set(args)
  if args ~= nil then
...
function LinkedFileEntity:match_get()
...
function LinkedFileEntity:stream(action, args, callopts)
...
---@param reqmatch LinkedFileLoadMatch
---@param ctrl? table
---@return LinkedFile
---@return string? err
function LinkedFileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch LinkedFileListMatch
---@param ctrl? table
---@return LinkedFile[]
---@return string? err
function LinkedFileEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata LinkedFileCreateData
---@param ctrl? table
---@return LinkedFile
---@return string? err
function LinkedFileEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata LinkedFileUpdateData
---@param ctrl? table
---@return LinkedFile
---@return string? err
function LinkedFileEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch LinkedFileRemoveMatch
---@param ctrl? table
---@return LinkedFile
---@return string? err
function LinkedFileEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function LinkedFileEntity:_run_op(ctx, post_done)
  local utility = self._utility
