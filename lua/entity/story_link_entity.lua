...
local StoryLinkEntity = {}
StoryLinkEntity.__index = StoryLinkEntity


function StoryLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StoryLinkEntity)
  self._name = "story_link"
  self._client = client
...
function StoryLinkEntity:get_name()
  return self._name
end


function StoryLinkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StoryLinkEntity.new(self._client, opts)
end
...
function StoryLinkEntity:mark_deleted()
  self._deleted = true
end


function StoryLinkEntity:deleted()
  return true == self._deleted
end


function StoryLinkEntity:data_set(args)
  if args ~= nil then
...
function StoryLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StoryLinkEntity:match_set(args)
  if args ~= nil then
...
function StoryLinkEntity:match_get()
...
function StoryLinkEntity:stream(action, args, callopts)
...
---@param reqmatch StoryLinkLoadMatch
---@param ctrl? table
---@return StoryLink
---@return string? err
function StoryLinkEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata StoryLinkCreateData
---@param ctrl? table
---@return StoryLink
---@return string? err
function StoryLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata StoryLinkUpdateData
---@param ctrl? table
---@return StoryLink
---@return string? err
function StoryLinkEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch StoryLinkRemoveMatch
---@param ctrl? table
---@return StoryLink
---@return string? err
function StoryLinkEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function StoryLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility
