...
local IterationEntity = {}
IterationEntity.__index = IterationEntity


function IterationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IterationEntity)
...
function IterationEntity:get_name()
  return self._name
end


function IterationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IterationEntity.new(self._client, opts)
end
...
function IterationEntity:mark_deleted()
  self._deleted = true
end


function IterationEntity:deleted()
  return true == self._deleted
end


function IterationEntity:data_set(args)
  if args ~= nil then
...
function IterationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IterationEntity:match_set(args)
  if args ~= nil then
...
function IterationEntity:match_get()
...
function IterationEntity:stream(action, args, callopts)
...
---@param reqmatch IterationLoadMatch
---@param ctrl? table
---@return Iteration
---@return string? err
function IterationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch IterationListMatch
---@param ctrl? table
---@return Iteration[]
---@return string? err
function IterationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata IterationCreateData
---@param ctrl? table
---@return Iteration
---@return string? err
function IterationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata IterationUpdateData
---@param ctrl? table
---@return Iteration
---@return string? err
function IterationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch IterationRemoveMatch
---@param ctrl? table
---@return Iteration
---@return string? err
function IterationEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function IterationEntity:_run_op(ctx, post_done)
  local utility = self._utility
