...
local ObjectiveEntity = {}
ObjectiveEntity.__index = ObjectiveEntity


function ObjectiveEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ObjectiveEntity)
...
function ObjectiveEntity:get_name()
  return self._name
end


function ObjectiveEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ObjectiveEntity.new(self._client, opts)
end
...
function ObjectiveEntity:mark_deleted()
  self._deleted = true
end


function ObjectiveEntity:deleted()
  return true == self._deleted
end


function ObjectiveEntity:data_set(args)
  if args ~= nil then
...
function ObjectiveEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ObjectiveEntity:match_set(args)
  if args ~= nil then
...
function ObjectiveEntity:match_get()
...
function ObjectiveEntity:stream(action, args, callopts)
...
---@param reqmatch ObjectiveLoadMatch
---@param ctrl? table
---@return Objective
---@return string? err
function ObjectiveEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ObjectiveListMatch
---@param ctrl? table
---@return Objective[]
---@return string? err
function ObjectiveEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ObjectiveCreateData
---@param ctrl? table
---@return Objective
---@return string? err
function ObjectiveEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ObjectiveUpdateData
---@param ctrl? table
---@return Objective
---@return string? err
function ObjectiveEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ObjectiveEntity:_run_op(ctx, post_done)
  local utility = self._utility
