...
---@param reqdata CategoryCreateData
---@param ctrl? table
---@return Category
---@return string? err
function CategoryEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CategoryUpdateData
---@param ctrl? table
---@return Category
---@return string? err
function CategoryEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CategoryRemoveMatch
---@param ctrl? table
---@return Category
---@return string? err
function CategoryEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
