...
local EpicPaginatedResultEntity = {}
EpicPaginatedResultEntity.__index = EpicPaginatedResultEntity


function EpicPaginatedResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EpicPaginatedResultEntity)
  self._name = "epic_paginated_result"
  self._client = client
...
function EpicPaginatedResultEntity:get_name()
  return self._name
end


function EpicPaginatedResultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EpicPaginatedResultEntity.new(self._client, opts)
end
...
function EpicPaginatedResultEntity:mark_deleted()
  self._deleted = true
end


function EpicPaginatedResultEntity:deleted()
  return true == self._deleted
end


function EpicPaginatedResultEntity:data_set(args)
  if args ~= nil then
...
function EpicPaginatedResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EpicPaginatedResultEntity:match_set(args)
  if args ~= nil then
...
function EpicPaginatedResultEntity:match_get()
...
function EpicPaginatedResultEntity:stream(action, args, callopts)
...
---@param reqmatch EpicPaginatedResultListMatch
---@param ctrl? table
---@return EpicPaginatedResult[]
---@return string? err
function EpicPaginatedResultEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EpicPaginatedResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EpicPaginatedResultEntity
