...
class ShortcutGraphql
{
    ...
    // equivalent.
    public static function body(ShortcutContext $ctx): mixed
    {
    ...
    public static function errors(ShortcutContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
