...
class ShortcutFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShortcutSDK/1.0)';
    ...
    public static function call(ShortcutContext $ctx, string $fullurl, array $fetchdef): array
    {
