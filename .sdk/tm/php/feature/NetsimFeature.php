...
class ShortcutNetsimFeature extends ShortcutBaseFeature
{
    ...
    private function _simulate(ShortcutContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ShortcutContext $ctx, array $applied): void
    {
        $client = $this->client;
