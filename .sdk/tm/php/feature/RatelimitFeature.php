...
// Shortcut SDK ratelimit feature
...
class ShortcutRatelimitFeature extends ShortcutBaseFeature
{
    ...
    private function _acquire(ShortcutContext $ctx): void
    {
    ...
    private function _track(ShortcutContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
