...
class ShortcutRbacFeature extends ShortcutBaseFeature
{
    ...
    private function _required(ShortcutContext $ctx): ?string
    {
    ...
    private function _reject(ShortcutContext $ctx, string $required): void
    {
    ...
    private function _track(ShortcutContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
