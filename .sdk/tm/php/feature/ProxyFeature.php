...
class ShortcutProxyFeature extends ShortcutBaseFeature
{
    ...
    public function init(ShortcutContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShortcutContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
