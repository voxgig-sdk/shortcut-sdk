...
class ShortcutPagingFeature extends ShortcutBaseFeature
{
    ...
    private function _graphql_pre_request(ShortcutContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ShortcutContext $ctx): bool
    {
