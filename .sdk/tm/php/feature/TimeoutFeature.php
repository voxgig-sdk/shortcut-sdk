...
class ShortcutTimeoutFeature extends ShortcutBaseFeature
{
    ...
    private function _with_timeout(ShortcutContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShortcutContext $_ctx, float $ms): void
    {
        $client = $this->client;
