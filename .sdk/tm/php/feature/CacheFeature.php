...
class ShortcutCacheFeature extends ShortcutBaseFeature
{
    ...
    private function _through(ShortcutContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
