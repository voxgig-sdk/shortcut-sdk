...
from projectname_sdk.core.control import ShortcutControl
...
class ShortcutContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ShortcutResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ShortcutResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ShortcutError(code, msg, self)
