...
class ShortcutTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShortcutTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ShortcutTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ShortcutTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
