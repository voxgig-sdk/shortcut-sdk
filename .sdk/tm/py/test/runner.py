...
class ShortcutTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShortcutTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ShortcutTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ShortcutTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
