...
from projectname_sdk import ShortcutSDK
from projectname_sdk.core.spec import ShortcutSpec
from projectname_sdk.core.result import ShortcutResult
from projectname_sdk.core.response import ShortcutResponse
from projectname_sdk.core.operation import ShortcutOperation
from projectname_sdk.core.error import ShortcutError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ShortcutBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ShortcutSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ShortcutSDK.test(None, None)
        ...
        class TestInitFeature(ShortcutBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ShortcutBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ShortcutSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ShortcutSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ShortcutSDK.test(None, setup_opts)
