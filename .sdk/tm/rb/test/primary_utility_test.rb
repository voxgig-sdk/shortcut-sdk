...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ShortcutOmni.make_runner(TEST_JSON_FILE, ShortcutSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ShortcutOmni.errify(err)
    end
