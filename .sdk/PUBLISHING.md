...
|---|---|---|
| `js/` | @voxgig-sdk/shortcut-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/shortcut | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/shortcut-js \
      --repository voxgig-sdk/shortcut-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/shortcut-js` shows it, and
`npm trust revoke @voxgig-sdk/shortcut-js --id=<id>` removes it.
