...
| `story_contents` | `Object` | A map of story attributes this template populates. |
...
| `health` | `Object` | The current health status of the Epic. |
...
| `stats` | `Object` | A group of calculated values for this Epic. |
...
| `display_icon` | `Object` | Icons are used to attach images to Groups, Workspaces, Members, and Loading screens in the Shortcut web application. |
...
| `stats` | `Object` | A group of calculated values for this Iteration. |
...
| Field | Type | Description |
| --- | --- | --- |
| `current_observed_value` | `Object` | The starting value of the Key Result. |
| `current_target_value` | `Object` | The starting value of the Key Result. |
| `id` | `string` | The ID of the Key Result. |
| `initial_observed_value` | `Object` | The starting value of the Key Result. |
| `name` | `string` | The name of the Key Result. |
| `objective_id` | `number` | The Objective to which this Key Result belongs. |
| `observed_value` | `Object` | The starting value of the Key Result. |
| `progress` | `number` | The integer percentage of progress toward completion of the Key Result. |
| `target_value` | `Object` | The starting value of the Key Result. |
...
| `stats` | `Object` | A group of calculated values for this Label. |
...
| `profile` | `Object` | A group of Member profile details. |
...
| `stats` | `Object` | A group of calculated values for this Milestone. |
...
| `stats` | `Object` | A group of calculated values for this Objective. |
...
| `stats` | `Object` | A group of calculated values for this Project. |
...
| Field | Type | Description |
| --- | --- | --- |
| `epics` | `Object` | The results of the Epic search query. |
| `iterations` | `Object` | The results of the Iteration search query. |
| `milestones` | `Object` | The results of the Objective search query. |
| `stories` | `Object` | The results of the Story search query. |

#### Example: Load

```ts
const search = await client.Search().load({ query: 'query' })
```
...
| `stats` | `Object` | The stats object for Stories |
...
| `synced_item` | `Object` | The synced item for the story. |
...
```ts
const storys = await client.Story().list({ query: "example" })
```
