...
const { CommentEntity } = require('./entity/CommentEntity')
const { CustomFieldEntity } = require('./entity/CustomFieldEntity')
const { DisableEntity } = require('./entity/DisableEntity')
const { DocSlimEntity } = require('./entity/DocSlimEntity')
const { EnableEntity } = require('./entity/EnableEntity')
const { EntityTemplateEntity } = require('./entity/EntityTemplateEntity')
const { EpicEntity } = require('./entity/EpicEntity')
const { EpicPaginatedResultEntity } = require('./entity/EpicPaginatedResultEntity')
const { EpicUnlinkProductboardEntity } = require('./entity/EpicUnlinkProductboardEntity')
const { EpicWorkflowEntity } = require('./entity/EpicWorkflowEntity')
...
const { IterationEntity } = require('./entity/IterationEntity')
const { KeyResultEntity } = require('./entity/KeyResultEntity')
const { LabelEntity } = require('./entity/LabelEntity')
const { LinkedFileEntity } = require('./entity/LinkedFileEntity')
const { MemberEntity } = require('./entity/MemberEntity')
const { MilestoneEntity } = require('./entity/MilestoneEntity')
const { ObjectifEntity } = require('./entity/ObjectifEntity')
const { ObjectiveEntity } = require('./entity/ObjectiveEntity')
...
const { StoryEntity } = require('./entity/StoryEntity')
const { StoryCommentEntity } = require('./entity/StoryCommentEntity')
const { StoryLinkEntity } = require('./entity/StoryLinkEntity')
const { StoryReactionEntity } = require('./entity/StoryReactionEntity')
const { StorySlimEntity } = require('./entity/StorySlimEntity')
const { TaskEntity } = require('./entity/TaskEntity')
const { ThreadedCommentEntity } = require('./entity/ThreadedCommentEntity')
const { UploadedFileEntity } = require('./entity/UploadedFileEntity')
...
const { ShortcutEntityBase } = require('./ShortcutEntityBase')
