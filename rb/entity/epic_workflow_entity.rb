...
class EpicWorkflowEntity
  ...
  def make
    opts = @_entopts.dup
    EpicWorkflowEntity.new(@_client, opts)
  end
  ...
  # @return [EpicWorkflow, Hash] the current EpicWorkflow data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EpicWorkflow fields)
  def match_get
  ...
  #
  # @param reqmatch [EpicWorkflowListMatch, Hash, nil] match filter (any subset of
  #   EpicWorkflow fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EpicWorkflow>, Array] the matching EpicWorkflow items; raises ShortcutError on failure
