...
class EpicUnlinkProductboardEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "epic_unlink_productboard"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    EpicUnlinkProductboardEntity.new(@_client, opts)
  end
  ...
  # @return [EpicUnlinkProductboard, Hash] the current EpicUnlinkProductboard data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EpicUnlinkProductboard fields)
  def match_get
  ...
  #
  # @param reqdata [EpicUnlinkProductboardCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EpicUnlinkProductboard, Hash] the created EpicUnlinkProductboard; raises ShortcutError on failure
