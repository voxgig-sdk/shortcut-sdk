...
class ObjectifEntity
  ...
  def make
    opts = @_entopts.dup
    ObjectifEntity.new(@_client, opts)
  end
  ...
  # @return [Objectif, Hash] the current Objectif data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Objectif fields)
  def match_get
  ...
  #
  # @param reqmatch [ObjectifRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Objectif, Hash] the removed Objectif; raises ShortcutError on failure
