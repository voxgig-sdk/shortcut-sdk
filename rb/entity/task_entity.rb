...
class TaskEntity
  ...
  # @return [Task, Hash] the loaded Task; raises ShortcutError on failure
  ...
  # Create a new Task.
  #
  # @param reqdata [TaskCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Task, Hash] the created Task; raises ShortcutError on failure
  ...
  #
  # @param reqdata [TaskUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Task, Hash] the updated Task; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [TaskRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Task, Hash] the removed Task; raises ShortcutError on failure
