...
class StoryLinkEntity
  ...
  def make
    opts = @_entopts.dup
    StoryLinkEntity.new(@_client, opts)
  end
  ...
  # @return [StoryLink, Hash] the current StoryLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StoryLink fields)
  def match_get
  ...
  #
  # @param reqmatch [StoryLinkLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StoryLink.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryLink, Hash] the loaded StoryLink; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StoryLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryLink, Hash] the created StoryLink; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StoryLinkUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryLink, Hash] the updated StoryLink; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [StoryLinkRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryLink, Hash] the removed StoryLink; raises ShortcutError on failure
