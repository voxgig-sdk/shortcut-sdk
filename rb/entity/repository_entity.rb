# Shortcut SDK Repository entity
...
class RepositoryEntity
  ...
  def make
    opts = @_entopts.dup
    RepositoryEntity.new(@_client, opts)
  end
  ...
  # @return [Repository, Hash] the current Repository data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Repository fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Repository.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Repository, Hash] the loaded Repository; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [RepositoryListMatch, Hash, nil] match filter (any subset of
  #   Repository fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Repository>, Array] the matching Repository items; raises ShortcutError on failure
