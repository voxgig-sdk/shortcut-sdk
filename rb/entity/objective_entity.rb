...
class ObjectiveEntity
  ...
  def make
    opts = @_entopts.dup
    ObjectiveEntity.new(@_client, opts)
  end
  ...
  # @return [Objective, Hash] the current Objective data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Objective fields)
  def match_get
  ...
  #
  # @param reqmatch [ObjectiveLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Objective.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Objective, Hash] the loaded Objective; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [ObjectiveListMatch, Hash, nil] match filter (any subset of
  #   Objective fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Objective>, Array] the matching Objective items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [ObjectiveCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Objective, Hash] the created Objective; raises ShortcutError on failure
  ...
  #
  # @param reqdata [ObjectiveUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Objective, Hash] the updated Objective; raises ShortcutError on failure
