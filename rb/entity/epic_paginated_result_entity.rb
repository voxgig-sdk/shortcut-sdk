...
class EpicPaginatedResultEntity
  ...
  def make
    opts = @_entopts.dup
    EpicPaginatedResultEntity.new(@_client, opts)
  end
  ...
  # @return [EpicPaginatedResult, Hash] the current EpicPaginatedResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EpicPaginatedResult fields)
  def match_get
  ...
  #
  # @param reqmatch [EpicPaginatedResultListMatch, Hash, nil] match filter (any subset of
  #   EpicPaginatedResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EpicPaginatedResult>, Array] the matching EpicPaginatedResult items; raises ShortcutError on failure
