...
class HealthEntity
  ...
  # @return [Health, Hash] the loaded Health; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Health>, Array] the matching Health items; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Health, Hash] the created Health; raises ShortcutError on failure
  ...
  # Update an existing Health.
  #
  # @param reqdata [HealthUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Health, Hash] the updated Health; raises ShortcutError on failure
