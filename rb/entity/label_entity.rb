...
class LabelEntity
  ...
  # @return [Label, Hash] the loaded Label; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Label>, Array] the matching Label items; raises ShortcutError on failure
  ...
  # Create a new Label.
  #
  # @param reqdata [LabelCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Label, Hash] the created Label; raises ShortcutError on failure
  ...
  #
  # @param reqdata [LabelUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Label, Hash] the updated Label; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [LabelRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Label, Hash] the removed Label; raises ShortcutError on failure
