...
class WebhookEntity
  ...
  # @return [Webhook, Hash] the loaded Webhook; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the created Webhook; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the removed Webhook; raises ShortcutError on failure
