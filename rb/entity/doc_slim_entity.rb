...
class DocSlimEntity
  ...
  def make
    opts = @_entopts.dup
    DocSlimEntity.new(@_client, opts)
  end
  ...
  # @return [DocSlim, Hash] the current DocSlim data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DocSlim fields)
  def match_get
  ...
  #
  # @param reqmatch [DocSlimListMatch, Hash, nil] match filter (any subset of
  #   DocSlim fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DocSlim>, Array] the matching DocSlim items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [DocSlimCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DocSlim, Hash] the created DocSlim; raises ShortcutError on failure
