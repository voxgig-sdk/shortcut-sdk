# Shortcut SDK CustomField entity
...
class CustomFieldEntity
  ...
  def make
    opts = @_entopts.dup
    CustomFieldEntity.new(@_client, opts)
  end
  ...
  # @return [CustomField, Hash] the current CustomField data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CustomField fields)
  def match_get
  ...
  #
  # @param reqmatch [CustomFieldLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CustomField.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomField, Hash] the loaded CustomField; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [CustomFieldListMatch, Hash, nil] match filter (any subset of
  #   CustomField fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CustomField>, Array] the matching CustomField items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [CustomFieldUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomField, Hash] the updated CustomField; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [CustomFieldRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomField, Hash] the removed CustomField; raises ShortcutError on failure
