...
class ProjectEntity
  ...
  # @return [Project, Hash] the loaded Project; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Project>, Array] the matching Project items; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the created Project; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the updated Project; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Project, Hash] the removed Project; raises ShortcutError on failure
