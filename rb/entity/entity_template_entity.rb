...
class EntityTemplateEntity
  ...
  def make
    opts = @_entopts.dup
    EntityTemplateEntity.new(@_client, opts)
  end
  ...
  # @return [EntityTemplate, Hash] the current EntityTemplate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EntityTemplate fields)
  def match_get
  ...
  #
  # @param reqmatch [EntityTemplateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EntityTemplate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EntityTemplate, Hash] the loaded EntityTemplate; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [EntityTemplateListMatch, Hash, nil] match filter (any subset of
  #   EntityTemplate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EntityTemplate>, Array] the matching EntityTemplate items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [EntityTemplateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EntityTemplate, Hash] the created EntityTemplate; raises ShortcutError on failure
  ...
  #
  # @param reqdata [EntityTemplateUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EntityTemplate, Hash] the updated EntityTemplate; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [EntityTemplateRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [EntityTemplate, Hash] the removed EntityTemplate; raises ShortcutError on failure
