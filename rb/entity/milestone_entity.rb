...
class MilestoneEntity
  ...
  def make
    opts = @_entopts.dup
    MilestoneEntity.new(@_client, opts)
  end
  ...
  # @return [Milestone, Hash] the current Milestone data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Milestone fields)
  def match_get
  ...
  #
  # @param reqmatch [MilestoneLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Milestone.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Milestone, Hash] the loaded Milestone; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [MilestoneListMatch, Hash, nil] match filter (any subset of
  #   Milestone fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Milestone>, Array] the matching Milestone items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [MilestoneCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Milestone, Hash] the created Milestone; raises ShortcutError on failure
  ...
  #
  # @param reqdata [MilestoneUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Milestone, Hash] the updated Milestone; raises ShortcutError on failure
  ...
  # Remove an Milestone matching the given criteria.
  #
  # @param reqmatch [MilestoneRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Milestone, Hash] the removed Milestone; raises ShortcutError on failure
