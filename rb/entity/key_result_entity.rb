...
class KeyResultEntity
  ...
  def make
    opts = @_entopts.dup
    KeyResultEntity.new(@_client, opts)
  end
  ...
  # @return [KeyResult, Hash] the current KeyResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of KeyResult fields)
  def match_get
  ...
  #
  # @param reqmatch [KeyResultLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.KeyResult.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [KeyResult, Hash] the loaded KeyResult; raises ShortcutError on failure
  ...
  #
  # @param reqdata [KeyResultUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [KeyResult, Hash] the updated KeyResult; raises ShortcutError on failure
