...
class GroupEntity
  ...
  # @return [Group, Hash] the loaded Group; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Group>, Array] the matching Group items; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the created Group; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Group, Hash] the updated Group; raises ShortcutError on failure
