...
class IterationEntity
  ...
  def make
    opts = @_entopts.dup
    IterationEntity.new(@_client, opts)
  end
  ...
  # @return [Iteration, Hash] the current Iteration data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Iteration fields)
  def match_get
  ...
  #
  # @param reqmatch [IterationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Iteration.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iteration, Hash] the loaded Iteration; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [IterationListMatch, Hash, nil] match filter (any subset of
  #   Iteration fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Iteration>, Array] the matching Iteration items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [IterationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iteration, Hash] the created Iteration; raises ShortcutError on failure
  ...
  #
  # @param reqdata [IterationUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iteration, Hash] the updated Iteration; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [IterationRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iteration, Hash] the removed Iteration; raises ShortcutError on failure
