...
class MemberEntity
  ...
  # @return [Member, Hash] the loaded Member; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Member>, Array] the matching Member items; raises ShortcutError on failure
