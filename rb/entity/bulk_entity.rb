...
class BulkEntity
  ...
  # @return [Bulk, Hash] the current Bulk data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Bulk fields)
  def match_get
  ...
  # Remove an Bulk matching the given criteria.
  #
  # @param reqmatch [BulkRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Bulk, Hash] the removed Bulk; raises ShortcutError on failure
