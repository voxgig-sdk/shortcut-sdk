...
class WorkflowEntity
  ...
  def make
    opts = @_entopts.dup
    WorkflowEntity.new(@_client, opts)
  end
  ...
  # @return [Workflow, Hash] the current Workflow data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Workflow fields)
  def match_get
  ...
  #
  # @param reqmatch [WorkflowLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Workflow.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Workflow, Hash] the loaded Workflow; raises ShortcutError on failure
  ...
  # List Workflow items matching the given filter.
  #
  # @param reqmatch [WorkflowListMatch, Hash, nil] match filter (any subset of
  #   Workflow fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Workflow>, Array] the matching Workflow items; raises ShortcutError on failure
