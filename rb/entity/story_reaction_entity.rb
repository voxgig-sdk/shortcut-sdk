...
class StoryReactionEntity
  ...
  def make
    opts = @_entopts.dup
    StoryReactionEntity.new(@_client, opts)
  end
  ...
  # @return [StoryReaction, Hash] the current StoryReaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StoryReaction fields)
  def match_get
  ...
  #
  # @param reqdata [StoryReactionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryReaction, Hash] the created StoryReaction; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [StoryReactionRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryReaction, Hash] the removed StoryReaction; raises ShortcutError on failure
