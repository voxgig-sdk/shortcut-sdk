...
class CategoryEntity
  ...
  # @return [Category, Hash] the loaded Category; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Category>, Array] the matching Category items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [CategoryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Category, Hash] the created Category; raises ShortcutError on failure
  ...
  #
  # @param reqdata [CategoryUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Category, Hash] the updated Category; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [CategoryRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Category, Hash] the removed Category; raises ShortcutError on failure
