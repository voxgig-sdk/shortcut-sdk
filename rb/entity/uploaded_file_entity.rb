...
class UploadedFileEntity
  ...
  def make
    opts = @_entopts.dup
    UploadedFileEntity.new(@_client, opts)
  end
  ...
  # @return [UploadedFile, Hash] the current UploadedFile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UploadedFile fields)
  def match_get
  ...
  #
  # @param reqmatch [UploadedFileLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UploadedFile.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UploadedFile, Hash] the loaded UploadedFile; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [UploadedFileListMatch, Hash, nil] match filter (any subset of
  #   UploadedFile fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UploadedFile>, Array] the matching UploadedFile items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [UploadedFileCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UploadedFile, Hash] the created UploadedFile; raises ShortcutError on failure
  ...
  #
  # @param reqdata [UploadedFileUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UploadedFile, Hash] the updated UploadedFile; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [UploadedFileRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [UploadedFile, Hash] the removed UploadedFile; raises ShortcutError on failure
