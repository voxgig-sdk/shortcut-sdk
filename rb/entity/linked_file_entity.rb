...
class LinkedFileEntity
  ...
  def make
    opts = @_entopts.dup
    LinkedFileEntity.new(@_client, opts)
  end
  ...
  # @return [LinkedFile, Hash] the current LinkedFile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LinkedFile fields)
  def match_get
  ...
  #
  # @param reqmatch [LinkedFileLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.LinkedFile.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [LinkedFile, Hash] the loaded LinkedFile; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [LinkedFileListMatch, Hash, nil] match filter (any subset of
  #   LinkedFile fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LinkedFile>, Array] the matching LinkedFile items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [LinkedFileCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [LinkedFile, Hash] the created LinkedFile; raises ShortcutError on failure
  ...
  #
  # @param reqdata [LinkedFileUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [LinkedFile, Hash] the updated LinkedFile; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [LinkedFileRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [LinkedFile, Hash] the removed LinkedFile; raises ShortcutError on failure
