...
class StoryEntity
  ...
  # Load a single Story.
  #
  # @param reqmatch [StoryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Story.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Story, Hash] the loaded Story; raises ShortcutError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Story>, Array] the matching Story items; raises ShortcutError on failure
  ...
  # Create a new Story.
  #
  # @param reqdata [StoryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Story, Hash] the created Story; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StoryUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Story, Hash] the updated Story; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [StoryRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Story, Hash] the removed Story; raises ShortcutError on failure
