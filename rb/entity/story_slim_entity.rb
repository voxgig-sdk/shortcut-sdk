...
class StorySlimEntity
  ...
  def make
    opts = @_entopts.dup
    StorySlimEntity.new(@_client, opts)
  end
  ...
  # @return [StorySlim, Hash] the current StorySlim data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StorySlim fields)
  def match_get
  ...
  #
  # @param reqdata [StorySlimCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StorySlim, Hash] the created StorySlim; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StorySlimUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StorySlim, Hash] the updated StorySlim; raises ShortcutError on failure
