...
class StoryCommentEntity
  ...
  def make
    opts = @_entopts.dup
    StoryCommentEntity.new(@_client, opts)
  end
  ...
  # @return [StoryComment, Hash] the current StoryComment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StoryComment fields)
  def match_get
  ...
  #
  # @param reqmatch [StoryCommentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StoryComment.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryComment, Hash] the loaded StoryComment; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [StoryCommentListMatch, Hash, nil] match filter (any subset of
  #   StoryComment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<StoryComment>, Array] the matching StoryComment items; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StoryCommentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryComment, Hash] the created StoryComment; raises ShortcutError on failure
  ...
  #
  # @param reqdata [StoryCommentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoryComment, Hash] the updated StoryComment; raises ShortcutError on failure
