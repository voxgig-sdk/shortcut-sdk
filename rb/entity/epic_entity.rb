...
class EpicEntity
  ...
  # @return [Epic, Hash] the current Epic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Epic fields)
  def match_get
  ...
  # Load a single Epic.
  #
  # @param reqmatch [EpicLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Epic.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Epic, Hash] the loaded Epic; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [EpicListMatch, Hash, nil] match filter (any subset of
  #   Epic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Epic>, Array] the matching Epic items; raises ShortcutError on failure
  ...
  # Create a new Epic.
  #
  # @param reqdata [EpicCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Epic, Hash] the created Epic; raises ShortcutError on failure
  ...
  #
  # @param reqdata [EpicUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Epic, Hash] the updated Epic; raises ShortcutError on failure
  ...
  #
  # @param reqmatch [EpicRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Epic, Hash] the removed Epic; raises ShortcutError on failure
