...
module ShortcutTestRunner
  ...
  def self.env_override(m)
    live = getenv("SHORTCUT_TEST_LIVE")
    override = getenv("SHORTCUT_TEST_OVERRIDE")
    ...
    explain = getenv("SHORTCUT_TEST_EXPLAIN")
    m["SHORTCUT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
