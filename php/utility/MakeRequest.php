...
// Shortcut SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ShortcutMakeRequest
{
    public static function call(ShortcutContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ShortcutResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ShortcutResponse($fetched);
        } else {
