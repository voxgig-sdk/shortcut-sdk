...
class StoryLinkDirectTest extends TestCase
{
    public function test_direct_load_story_link(): void
    {
        $setup = story_link_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-story_link", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
