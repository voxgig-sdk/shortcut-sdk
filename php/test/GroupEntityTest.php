...
class GroupEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_GROUP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $group_ref01_markdef_up0_name = "app_url";
...
function group_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHORTCUT_TEST_GROUP_ENTID");
