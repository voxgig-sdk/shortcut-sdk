...
class CategoryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_CATEGORY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $category_ref01_ent->remove($category_ref01_match_rm0, null);

        // LIST
        $category_ref01_match_rt0 = [];

        $category_ref01_list_rt0_result = $category_ref01_ent->list($category_ref01_match_rt0, null);
        $this->assertIsArray($category_ref01_list_rt0_result);
...
function category_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHORTCUT_TEST_CATEGORY_ENTID");
