...
{
    private static function utility(): ShortcutUtility
    {
        return new ShortcutUtility();
    }
    ...
    private static function ctx(array $over = []): ShortcutContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ShortcutContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ShortcutOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ShortcutError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ShortcutOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ShortcutMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ShortcutOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ShortcutMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ShortcutOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ShortcutMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ShortcutSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ShortcutMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ShortcutResponse([]),
            'result' => new ShortcutResult([]),
        ]);
        [, $err] = ShortcutMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ShortcutSpec(['step' => 's']),
            'response' => new ShortcutResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ShortcutResult([]),
        ]);
        [, $err] = ShortcutMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ShortcutSpec(['step' => 's']),
            'response' => new ShortcutResponse(self::resp(200, ['v' => 1])),
            'result' => new ShortcutResult([]),
        ]);
        [, $err] = ShortcutMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ShortcutSpec(['step' => 's']),
            'response' => new ShortcutResponse(self::resp(200, ['v' => 2])),
            'result' => new ShortcutResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ShortcutMakeResponse::call($ctx);
    ...
    {
        $preset = new ShortcutResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ShortcutSpec([]),
            'response' => new ShortcutResponse([]),
            'result' => new ShortcutResult([]),
        ...
        [$got, $err] = ShortcutMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ShortcutResult([])]);
        [, $err] = ShortcutMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ShortcutSpec([]), 'result' => null]);
        [, $err] = ShortcutMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ShortcutSpec(['step' => 's']),
            'result' => new ShortcutResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ShortcutOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ShortcutMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ShortcutSpec(['step' => 's']),
            'result' => new ShortcutResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ShortcutOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ShortcutMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ShortcutResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ShortcutSpec([]),
            'result' => new ShortcutResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ShortcutMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ShortcutMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ShortcutError('boom', 'boom');
        $utility->fetcher = function (ShortcutContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ShortcutSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ShortcutMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ShortcutContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ShortcutMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ShortcutResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ShortcutContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ShortcutSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ShortcutMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ShortcutResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ShortcutSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ShortcutMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ShortcutMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ShortcutMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ShortcutResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ShortcutDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ShortcutResult(['ok' => false])]);
        $this->expectException(ShortcutError::class);
        ShortcutDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ShortcutResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ShortcutMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ShortcutMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ShortcutBaseFeature();
        $b = new ShortcutBaseFeature();
        ShortcutFeatureAdd::call($ctx, $a);
        ShortcutFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ShortcutBaseFeature
    {
        $f = new ShortcutBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ShortcutFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ShortcutContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ShortcutSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ShortcutPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ShortcutResponse(['headers' => null]),
            'result' => new ShortcutResult([]),
        ]);
        ShortcutResultHeaders::call($ctx);
