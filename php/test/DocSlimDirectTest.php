...
class DocSlimDirectTest extends TestCase
{
    public function test_direct_list_doc_slim(): void
    {
        $setup = doc_slim_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-doc_slim", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
