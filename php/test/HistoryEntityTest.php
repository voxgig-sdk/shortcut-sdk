...
class HistoryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_HISTORY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function history_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["history01", "history02", "history03", "story01", "story02", "story03"] as $k) {
    ...
    $entid_env_raw = getenv("SHORTCUT_TEST_HISTORY_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["SHORTCUT_TEST_HISTORY_ENTID"]);
