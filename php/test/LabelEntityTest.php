...
class LabelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_LABEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $label_ref01_list_rt0_result = $label_ref01_ent->list($label_ref01_match_rt0, null);
        $this->assertIsArray($label_ref01_list_rt0_result);
...
function label_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHORTCUT_TEST_LABEL_ENTID");
