...
class ShortcutTestRunner
{
    ...
    {
        $live = self::getenv('SHORTCUT_TEST_LIVE');
        $override = self::getenv('SHORTCUT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SHORTCUT_TEST_EXPLAIN');
...
class_alias('ShortcutTestRunner', 'Runner');
class_alias('ShortcutHelpers', 'Helpers');
