...
class KeyResultDirectTest extends TestCase
{
    public function test_direct_load_key_result(): void
    {
        $setup = key_result_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-key_result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
