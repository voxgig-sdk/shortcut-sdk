...
// Shortcut SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShortcutSDK::test)
...
{
    private const SDK_CLASS = 'ShortcutSDK';
    ...
    private const SDK_BASE = 'shortcut_sdk';
