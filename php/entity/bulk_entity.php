...
class BulkEntity
{
     ...
     *
     * @param BulkRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BulkRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bulk|array The removed Bulk as an assoc-array at the
