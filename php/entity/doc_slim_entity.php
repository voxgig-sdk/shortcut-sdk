...
class DocSlimEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DocSlimEntity($this->_client, $opts);
    }

    /**
     * @param DocSlim|array $args DocSlim data (assoc-array) to store.
     */
    ...
    /**
     * @return DocSlim|array The current DocSlim data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DocSlim fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DocSlim fields).
     */
    ...
    /**
     * List DocSlim items matching the given filter.
     *
     * @param DocSlimListMatch|array|null $reqmatch Match filter (any subset
     *   of DocSlim fields) as an assoc-array; DocSlimListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DocSlim[]|array A list of DocSlim items as assoc-arrays at
    ...
    /**
     * Create a new DocSlim.
     *
     * @param DocSlimCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DocSlimCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DocSlim|array The created DocSlim as an assoc-array at the
