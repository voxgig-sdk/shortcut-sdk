...
// Shortcut SDK UploadedFile entity
...
class UploadedFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UploadedFileEntity($this->_client, $opts);
    }

    /**
     * @param UploadedFile|array $args UploadedFile data (assoc-array) to store.
     */
    ...
    /**
     * @return UploadedFile|array The current UploadedFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UploadedFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UploadedFile fields).
     */
    ...
    /**
     * Load a single UploadedFile.
     *
     * @param UploadedFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UploadedFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadedFile|array The loaded UploadedFile as an assoc-array at the
    ...
    /**
     * List UploadedFile items matching the given filter.
     *
     * @param UploadedFileListMatch|array|null $reqmatch Match filter (any subset
     *   of UploadedFile fields) as an assoc-array; UploadedFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadedFile[]|array A list of UploadedFile items as assoc-arrays at
     ...
     *
     * @param UploadedFileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UploadedFileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadedFile|array The created UploadedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing UploadedFile.
     *
     * @param UploadedFileUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UploadedFileUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadedFile|array The updated UploadedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an UploadedFile matching the given criteria.
     *
     * @param UploadedFileRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; UploadedFileRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadedFile|array The removed UploadedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
