...
class StorySlimEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StorySlimEntity($this->_client, $opts);
    }

    /**
     * @param StorySlim|array $args StorySlim data (assoc-array) to store.
     */
    ...
    /**
     * @return StorySlim|array The current StorySlim data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StorySlim fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StorySlim fields).
     */
    ...
    /**
     * Create a new StorySlim.
     *
     * @param StorySlimCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StorySlimCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StorySlim|array The created StorySlim as an assoc-array at the
    ...
    /**
     * Update an existing StorySlim.
     *
     * @param StorySlimUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StorySlimUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StorySlim|array The updated StorySlim as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
