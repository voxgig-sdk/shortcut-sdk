...
// Shortcut SDK LinkedFile entity
...
class LinkedFileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LinkedFileEntity($this->_client, $opts);
    }

    /**
     * @param LinkedFile|array $args LinkedFile data (assoc-array) to store.
     */
    ...
    /**
     * @return LinkedFile|array The current LinkedFile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LinkedFile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LinkedFile fields).
     */
    ...
    /**
     * Load a single LinkedFile.
     *
     * @param LinkedFileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LinkedFileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkedFile|array The loaded LinkedFile as an assoc-array at the
    ...
    /**
     * List LinkedFile items matching the given filter.
     *
     * @param LinkedFileListMatch|array|null $reqmatch Match filter (any subset
     *   of LinkedFile fields) as an assoc-array; LinkedFileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkedFile[]|array A list of LinkedFile items as assoc-arrays at
    ...
    /**
     * Create a new LinkedFile.
     *
     * @param LinkedFileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LinkedFileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkedFile|array The created LinkedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing LinkedFile.
     *
     * @param LinkedFileUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LinkedFileUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkedFile|array The updated LinkedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an LinkedFile matching the given criteria.
     *
     * @param LinkedFileRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LinkedFileRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkedFile|array The removed LinkedFile as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
