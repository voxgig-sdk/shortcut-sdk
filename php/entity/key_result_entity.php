...
class KeyResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new KeyResultEntity($this->_client, $opts);
    }

    /**
     * @param KeyResult|array $args KeyResult data (assoc-array) to store.
     */
    ...
    /**
     * @return KeyResult|array The current KeyResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of KeyResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of KeyResult fields).
     */
    ...
    /**
     * Load a single KeyResult.
     *
     * @param KeyResultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed KeyResultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return KeyResult|array The loaded KeyResult as an assoc-array at the
    ...
    /**
     * Update an existing KeyResult.
     *
     * @param KeyResultUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed KeyResultUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return KeyResult|array The updated KeyResult as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
