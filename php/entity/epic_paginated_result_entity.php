...
// Shortcut SDK EpicPaginatedResult entity
...
class EpicPaginatedResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "epic_paginated_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EpicPaginatedResultEntity($this->_client, $opts);
    }

    /**
     * @param EpicPaginatedResult|array $args EpicPaginatedResult data (assoc-array) to store.
     */
    ...
    /**
     * @return EpicPaginatedResult|array The current EpicPaginatedResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EpicPaginatedResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EpicPaginatedResult fields).
     */
    ...
    /**
     * List EpicPaginatedResult items matching the given filter.
     *
     * @param EpicPaginatedResultListMatch|array|null $reqmatch Match filter (any subset
     *   of EpicPaginatedResult fields) as an assoc-array; EpicPaginatedResultListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EpicPaginatedResult[]|array A list of EpicPaginatedResult items as assoc-arrays at
