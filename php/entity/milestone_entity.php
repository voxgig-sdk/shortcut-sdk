...
class MilestoneEntity
{
     ...
     *
     * @param MilestoneRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MilestoneRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Milestone|array The removed Milestone as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
