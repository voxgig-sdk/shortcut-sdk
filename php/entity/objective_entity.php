...
class ObjectiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ObjectiveEntity($this->_client, $opts);
    }

    /**
     * @param Objective|array $args Objective data (assoc-array) to store.
     */
    ...
    /**
     * @return Objective|array The current Objective data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Objective fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Objective fields).
     */
    ...
    /**
     * Load a single Objective.
     *
     * @param ObjectiveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ObjectiveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Objective|array The loaded Objective as an assoc-array at the
    ...
    /**
     * List Objective items matching the given filter.
     *
     * @param ObjectiveListMatch|array|null $reqmatch Match filter (any subset
     *   of Objective fields) as an assoc-array; ObjectiveListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Objective[]|array A list of Objective items as assoc-arrays at
     ...
     *
     * @param ObjectiveCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ObjectiveCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Objective|array The created Objective as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
     ...
     *
     * @param ObjectiveUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ObjectiveUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Objective|array The updated Objective as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
