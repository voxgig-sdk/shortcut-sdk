...
class StoryEntity
{
     ...
     * Load a single Story.
     *
     * @param StoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Story|array The loaded Story as an assoc-array at the
     ...
     * Create a new Story.
     *
     * @param StoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Story|array The created Story as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
     ...
     *
     * @param StoryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Story|array The updated Story as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Story matching the given criteria.
     *
     * @param StoryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; StoryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Story|array The removed Story as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
