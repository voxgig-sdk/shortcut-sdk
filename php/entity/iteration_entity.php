...
class IterationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IterationEntity($this->_client, $opts);
    }

    /**
     * @param Iteration|array $args Iteration data (assoc-array) to store.
     */
    ...
    /**
     * @return Iteration|array The current Iteration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Iteration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Iteration fields).
     */
    ...
    /**
     * Load a single Iteration.
     *
     * @param IterationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IterationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iteration|array The loaded Iteration as an assoc-array at the
    ...
    /**
     * List Iteration items matching the given filter.
     *
     * @param IterationListMatch|array|null $reqmatch Match filter (any subset
     *   of Iteration fields) as an assoc-array; IterationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iteration[]|array A list of Iteration items as assoc-arrays at
     ...
     *
     * @param IterationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IterationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iteration|array The created Iteration as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
     ...
     *
     * @param IterationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IterationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iteration|array The updated Iteration as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Iteration matching the given criteria.
     *
     * @param IterationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IterationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iteration|array The removed Iteration as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
