...
class HealthEntity
{
     ...
     *
     * @param HealthUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HealthUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Health|array The updated Health as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
