...
class WorkflowEntity
{
     ...
     *
     * @param WorkflowListMatch|array|null $reqmatch Match filter (any subset
     *   of Workflow fields) as an assoc-array; WorkflowListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workflow[]|array A list of Workflow items as assoc-arrays at
