...
// Shortcut SDK StoryReaction entity
...
class StoryReactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StoryReactionEntity($this->_client, $opts);
    }

    /**
     * @param StoryReaction|array $args StoryReaction data (assoc-array) to store.
     */
    ...
    /**
     * @return StoryReaction|array The current StoryReaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StoryReaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StoryReaction fields).
     */
    ...
    /**
     * Create a new StoryReaction.
     *
     * @param StoryReactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryReactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryReaction|array The created StoryReaction as an assoc-array at the
    ...
    /**
     * Remove an StoryReaction matching the given criteria.
     *
     * @param StoryReactionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; StoryReactionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryReaction|array The removed StoryReaction as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
