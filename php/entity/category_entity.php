...
class CategoryEntity
{
     ...
     *
     * @param CategoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CategoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Category|array The created Category as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
     ...
     *
     * @param CategoryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CategoryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Category|array The updated Category as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Category matching the given criteria.
     *
     * @param CategoryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CategoryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Category|array The removed Category as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
