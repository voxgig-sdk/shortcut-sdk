...
class StoryLinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StoryLinkEntity($this->_client, $opts);
    }

    /**
     * @param StoryLink|array $args StoryLink data (assoc-array) to store.
     */
    ...
    /**
     * @return StoryLink|array The current StoryLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StoryLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StoryLink fields).
     */
    ...
    /**
     * Load a single StoryLink.
     *
     * @param StoryLinkLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StoryLinkLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryLink|array The loaded StoryLink as an assoc-array at the
    ...
    /**
     * Create a new StoryLink.
     *
     * @param StoryLinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryLinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryLink|array The created StoryLink as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing StoryLink.
     *
     * @param StoryLinkUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryLinkUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryLink|array The updated StoryLink as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an StoryLink matching the given criteria.
     *
     * @param StoryLinkRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; StoryLinkRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryLink|array The removed StoryLink as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
