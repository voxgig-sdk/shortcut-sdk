...
// Shortcut SDK EpicWorkflow entity
...
class EpicWorkflowEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EpicWorkflowEntity($this->_client, $opts);
    }

    /**
     * @param EpicWorkflow|array $args EpicWorkflow data (assoc-array) to store.
     */
    ...
    /**
     * @return EpicWorkflow|array The current EpicWorkflow data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EpicWorkflow fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EpicWorkflow fields).
     */
    ...
    /**
     * List EpicWorkflow items matching the given filter.
     *
     * @param EpicWorkflowListMatch|array|null $reqmatch Match filter (any subset
     *   of EpicWorkflow fields) as an assoc-array; EpicWorkflowListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EpicWorkflow[]|array A list of EpicWorkflow items as assoc-arrays at
