...
class ObjectifEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ObjectifEntity($this->_client, $opts);
    }

    /**
     * @param Objectif|array $args Objectif data (assoc-array) to store.
     */
    ...
    /**
     * @return Objectif|array The current Objectif data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Objectif fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Objectif fields).
     */
    ...
    /**
     * Remove an Objectif matching the given criteria.
     *
     * @param ObjectifRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ObjectifRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Objectif|array The removed Objectif as an assoc-array at the
