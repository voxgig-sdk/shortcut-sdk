...
class EpicUnlinkProductboardEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "epic_unlink_productboard";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EpicUnlinkProductboardEntity($this->_client, $opts);
    }

    /**
     * @param EpicUnlinkProductboard|array $args EpicUnlinkProductboard data (assoc-array) to store.
     */
    ...
    /**
     * @return EpicUnlinkProductboard|array The current EpicUnlinkProductboard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EpicUnlinkProductboard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EpicUnlinkProductboard fields).
     */
    ...
    /**
     * Create a new EpicUnlinkProductboard.
     *
     * @param EpicUnlinkProductboardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EpicUnlinkProductboardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EpicUnlinkProductboard|array The created EpicUnlinkProductboard as an assoc-array at the
