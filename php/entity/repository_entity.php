...
class RepositoryEntity
{
     ...
     *
     * @param RepositoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RepositoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repository|array The loaded Repository as an assoc-array at the
