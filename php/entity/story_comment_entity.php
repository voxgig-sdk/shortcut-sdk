...
// Shortcut SDK StoryComment entity
...
class StoryCommentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StoryCommentEntity($this->_client, $opts);
    }

    /**
     * @param StoryComment|array $args StoryComment data (assoc-array) to store.
     */
    ...
    /**
     * @return StoryComment|array The current StoryComment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StoryComment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StoryComment fields).
     */
    ...
    /**
     * Load a single StoryComment.
     *
     * @param StoryCommentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StoryCommentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryComment|array The loaded StoryComment as an assoc-array at the
    ...
    /**
     * List StoryComment items matching the given filter.
     *
     * @param StoryCommentListMatch|array|null $reqmatch Match filter (any subset
     *   of StoryComment fields) as an assoc-array; StoryCommentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryComment[]|array A list of StoryComment items as assoc-arrays at
    ...
    /**
     * Create a new StoryComment.
     *
     * @param StoryCommentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryCommentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryComment|array The created StoryComment as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing StoryComment.
     *
     * @param StoryCommentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoryCommentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoryComment|array The updated StoryComment as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
