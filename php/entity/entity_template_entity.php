...
// Shortcut SDK EntityTemplate entity
...
class EntityTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EntityTemplateEntity($this->_client, $opts);
    }

    /**
     * @param EntityTemplate|array $args EntityTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return EntityTemplate|array The current EntityTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EntityTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EntityTemplate fields).
     */
    ...
    /**
     * Load a single EntityTemplate.
     *
     * @param EntityTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EntityTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EntityTemplate|array The loaded EntityTemplate as an assoc-array at the
    ...
    /**
     * List EntityTemplate items matching the given filter.
     *
     * @param EntityTemplateListMatch|array|null $reqmatch Match filter (any subset
     *   of EntityTemplate fields) as an assoc-array; EntityTemplateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EntityTemplate[]|array A list of EntityTemplate items as assoc-arrays at
     ...
     *
     * @param EntityTemplateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EntityTemplateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EntityTemplate|array The created EntityTemplate as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EntityTemplate.
     *
     * @param EntityTemplateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EntityTemplateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EntityTemplate|array The updated EntityTemplate as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an EntityTemplate matching the given criteria.
     *
     * @param EntityTemplateRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EntityTemplateRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EntityTemplate|array The removed EntityTemplate as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
