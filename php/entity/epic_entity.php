...
class EpicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EpicEntity($this->_client, $opts);
    }

    /**
     * @param Epic|array $args Epic data (assoc-array) to store.
     */
    ...
    /**
     * @return Epic|array The current Epic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Epic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Epic fields).
     */
     ...
     * Load a single Epic.
     *
     * @param EpicLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EpicLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Epic|array The loaded Epic as an assoc-array at the
    ...
    /**
     * List Epic items matching the given filter.
     *
     * @param EpicListMatch|array|null $reqmatch Match filter (any subset
     *   of Epic fields) as an assoc-array; EpicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Epic[]|array A list of Epic items as assoc-arrays at
     ...
     * Create a new Epic.
     *
     * @param EpicCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EpicCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Epic|array The created Epic as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
     ...
     *
     * @param EpicUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EpicUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Epic|array The updated Epic as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Epic matching the given criteria.
     *
     * @param EpicRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EpicRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Epic|array The removed Epic as an assoc-array at the
     *   SDK boundary; throws ShortcutError on failure (item-5 convention).
     */
