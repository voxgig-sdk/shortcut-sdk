...
// Shortcut SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ShortcutTestFeature extends ShortcutBaseFeature
{
    ...
    public function init(ShortcutContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ShortcutContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ShortcutContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ShortcutContext $ctx, $op, $args): array
    {
