...
// Shortcut SDK streaming feature
...
class ShortcutStreamingFeature extends ShortcutBaseFeature
{
    ...
    private function _iterate(ShortcutResult $result): \Generator
    {
    ...
    private function _streamable(ShortcutContext $ctx): bool
    {
