...
class ShortcutClienttrackFeature extends ShortcutBaseFeature
{
    ...
    public function PostConstruct(ShortcutContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Shortcut-SDK';
