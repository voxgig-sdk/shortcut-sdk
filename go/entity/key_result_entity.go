...
func NewKeyResultEntity(client *core.ShortcutSDK, entopts map[string]any) *KeyResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KeyResultEntity) GetName() string { return e.name }
...
func (e *KeyResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KeyResultEntity) Deleted() bool {
	return e.deleted
}


func (e *KeyResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKeyResultEntity(e.client, opts)
}

func (e *KeyResultEntity) Data(args ...any) any {
...
func (e *KeyResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an KeyResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KeyResultEntity) DataTyped(data ...KeyResult) KeyResult {
	if len(data) > 0 {
		return typedFrom[KeyResult](e.Data(asMap(data[0])))
	}
	return typedFrom[KeyResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through KeyResult (all fields
// optional at the wire level).
func (e *KeyResultEntity) MatchTyped(match ...KeyResult) KeyResult {
	if len(match) > 0 {
		return typedFrom[KeyResult](e.Match(asMap(match[0])))
	}
	return typedFrom[KeyResult](e.Match())
}
...
func (e *KeyResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KeyResultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KeyResultLoadMatch and returns an KeyResult. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *KeyResultEntity) LoadTyped(reqmatch KeyResultLoadMatch, ctrl map[string]any) (KeyResult, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return KeyResult{}, err
	}
	return typedFrom[KeyResult](res), nil
}



func (e *KeyResultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *KeyResultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *KeyResultEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// KeyResultUpdateData and returns an KeyResult. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *KeyResultEntity) UpdateTyped(reqdata KeyResultUpdateData, ctrl map[string]any) (KeyResult, error) {
...
func (e *KeyResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KeyResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
