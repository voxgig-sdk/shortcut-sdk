...
func NewEpicEntity(client *core.ShortcutSDK, entopts map[string]any) *EpicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EpicEntity) GetName() string { return e.name }
...
func (e *EpicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EpicEntity) Deleted() bool {
	return e.deleted
}


func (e *EpicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEpicEntity(e.client, opts)
}

func (e *EpicEntity) Data(args ...any) any {
...
func (e *EpicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Epic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) DataTyped(data ...Epic) Epic {
	if len(data) > 0 {
		return typedFrom[Epic](e.Data(asMap(data[0])))
	}
	return typedFrom[Epic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Epic (all fields
// optional at the wire level).
func (e *EpicEntity) MatchTyped(match ...Epic) Epic {
	if len(match) > 0 {
		return typedFrom[Epic](e.Match(asMap(match[0])))
	}
	return typedFrom[Epic](e.Match())
}
...
func (e *EpicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EpicEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EpicLoadMatch and returns an Epic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) LoadTyped(reqmatch EpicLoadMatch, ctrl map[string]any) (Epic, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Epic{}, err
	}
	return typedFrom[Epic](res), nil
}




func (e *EpicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EpicListMatch and returns []Epic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) ListTyped(reqmatch EpicListMatch, ctrl map[string]any) ([]Epic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Epic](res), nil
}




func (e *EpicEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EpicCreateData and returns an Epic. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) CreateTyped(reqdata EpicCreateData, ctrl map[string]any) (Epic, error) {
...
func (e *EpicEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EpicUpdateData and returns an Epic. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) UpdateTyped(reqdata EpicUpdateData, ctrl map[string]any) (Epic, error) {
...
func (e *EpicEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EpicRemoveMatch and returns an Epic. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EpicEntity) RemoveTyped(reqmatch EpicRemoveMatch, ctrl map[string]any) (Epic, error) {
...
func (e *EpicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
