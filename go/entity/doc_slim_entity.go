...
func NewDocSlimEntity(client *core.ShortcutSDK, entopts map[string]any) *DocSlimEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DocSlimEntity) GetName() string { return e.name }
...
func (e *DocSlimEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DocSlimEntity) Deleted() bool {
	return e.deleted
}


func (e *DocSlimEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDocSlimEntity(e.client, opts)
}

func (e *DocSlimEntity) Data(args ...any) any {
...
func (e *DocSlimEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DocSlim; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DocSlimEntity) DataTyped(data ...DocSlim) DocSlim {
	if len(data) > 0 {
		return typedFrom[DocSlim](e.Data(asMap(data[0])))
	}
	return typedFrom[DocSlim](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DocSlim (all fields
// optional at the wire level).
func (e *DocSlimEntity) MatchTyped(match ...DocSlim) DocSlim {
	if len(match) > 0 {
		return typedFrom[DocSlim](e.Match(asMap(match[0])))
	}
	return typedFrom[DocSlim](e.Match())
}
...
func (e *DocSlimEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DocSlimEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DocSlimEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DocSlimListMatch and returns []DocSlim. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DocSlimEntity) ListTyped(reqmatch DocSlimListMatch, ctrl map[string]any) ([]DocSlim, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DocSlim](res), nil
}




func (e *DocSlimEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DocSlimCreateData and returns an DocSlim. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DocSlimEntity) CreateTyped(reqdata DocSlimCreateData, ctrl map[string]any) (DocSlim, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DocSlim{}, err
	}
	return typedFrom[DocSlim](res), nil
}



func (e *DocSlimEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DocSlimEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DocSlimEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
