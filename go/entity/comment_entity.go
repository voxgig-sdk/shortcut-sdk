...
func NewCommentEntity(client *core.ShortcutSDK, entopts map[string]any) *CommentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CommentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
