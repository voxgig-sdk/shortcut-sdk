...
func NewWorkflowEntity(client *core.ShortcutSDK, entopts map[string]any) *WorkflowEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkflowEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WorkflowListMatch and returns []Workflow. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WorkflowEntity) ListTyped(reqmatch WorkflowListMatch, ctrl map[string]any) ([]Workflow, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Workflow](res), nil
}
