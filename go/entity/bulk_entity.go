...
func NewBulkEntity(client *core.ShortcutSDK, entopts map[string]any) *BulkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BulkEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BulkRemoveMatch and returns an Bulk. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BulkEntity) RemoveTyped(reqmatch BulkRemoveMatch, ctrl map[string]any) (Bulk, error) {
