...
type EpicWorkflowEntity struct {
	name    string
...
func NewEpicWorkflowEntity(client *core.ShortcutSDK, entopts map[string]any) *EpicWorkflowEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EpicWorkflowEntity) GetName() string { return e.name }
...
func (e *EpicWorkflowEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EpicWorkflowEntity) Deleted() bool {
	return e.deleted
}


func (e *EpicWorkflowEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEpicWorkflowEntity(e.client, opts)
}

func (e *EpicWorkflowEntity) Data(args ...any) any {
...
func (e *EpicWorkflowEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EpicWorkflow; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EpicWorkflowEntity) DataTyped(data ...EpicWorkflow) EpicWorkflow {
	if len(data) > 0 {
		return typedFrom[EpicWorkflow](e.Data(asMap(data[0])))
	}
	return typedFrom[EpicWorkflow](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EpicWorkflow (all fields
// optional at the wire level).
func (e *EpicWorkflowEntity) MatchTyped(match ...EpicWorkflow) EpicWorkflow {
	if len(match) > 0 {
		return typedFrom[EpicWorkflow](e.Match(asMap(match[0])))
	}
	return typedFrom[EpicWorkflow](e.Match())
}
...
func (e *EpicWorkflowEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EpicWorkflowEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EpicWorkflowEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EpicWorkflowListMatch and returns []EpicWorkflow. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EpicWorkflowEntity) ListTyped(reqmatch EpicWorkflowListMatch, ctrl map[string]any) ([]EpicWorkflow, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EpicWorkflow](res), nil
}



func (e *EpicWorkflowEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EpicWorkflowEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EpicWorkflowEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EpicWorkflowEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
