...
func NewStoryEntity(client *core.ShortcutSDK, entopts map[string]any) *StoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StoryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StoryLoadMatch and returns an Story. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) LoadTyped(reqmatch StoryLoadMatch, ctrl map[string]any) (Story, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Story{}, err
	}
	return typedFrom[Story](res), nil
}
...
func (e *StoryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// StoryCreateData and returns an Story. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) CreateTyped(reqdata StoryCreateData, ctrl map[string]any) (Story, error) {
...
func (e *StoryEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// StoryUpdateData and returns an Story. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) UpdateTyped(reqdata StoryUpdateData, ctrl map[string]any) (Story, error) {
...
func (e *StoryEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// StoryRemoveMatch and returns an Story. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) RemoveTyped(reqmatch StoryRemoveMatch, ctrl map[string]any) (Story, error) {
