...
type StoryReactionEntity struct {
	name    string
...
func NewStoryReactionEntity(client *core.ShortcutSDK, entopts map[string]any) *StoryReactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StoryReactionEntity) GetName() string { return e.name }
...
func (e *StoryReactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StoryReactionEntity) Deleted() bool {
	return e.deleted
}


func (e *StoryReactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStoryReactionEntity(e.client, opts)
}

func (e *StoryReactionEntity) Data(args ...any) any {
...
func (e *StoryReactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StoryReaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StoryReactionEntity) DataTyped(data ...StoryReaction) StoryReaction {
	if len(data) > 0 {
		return typedFrom[StoryReaction](e.Data(asMap(data[0])))
	}
	return typedFrom[StoryReaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StoryReaction (all fields
// optional at the wire level).
func (e *StoryReactionEntity) MatchTyped(match ...StoryReaction) StoryReaction {
	if len(match) > 0 {
		return typedFrom[StoryReaction](e.Match(asMap(match[0])))
	}
	return typedFrom[StoryReaction](e.Match())
}
...
func (e *StoryReactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StoryReactionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *StoryReactionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *StoryReactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StoryReactionCreateData and returns an StoryReaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StoryReactionEntity) CreateTyped(reqdata StoryReactionCreateData, ctrl map[string]any) (StoryReaction, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return StoryReaction{}, err
	}
	return typedFrom[StoryReaction](res), nil
}



func (e *StoryReactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *StoryReactionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// StoryReactionRemoveMatch and returns an StoryReaction. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *StoryReactionEntity) RemoveTyped(reqmatch StoryReactionRemoveMatch, ctrl map[string]any) (StoryReaction, error) {
...
func (e *StoryReactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
