...
func NewObjectifEntity(client *core.ShortcutSDK, entopts map[string]any) *ObjectifEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ObjectifEntity) GetName() string { return e.name }
...
func (e *ObjectifEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ObjectifEntity) Deleted() bool {
	return e.deleted
}


func (e *ObjectifEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewObjectifEntity(e.client, opts)
}

func (e *ObjectifEntity) Data(args ...any) any {
...
func (e *ObjectifEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Objectif; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ObjectifEntity) DataTyped(data ...Objectif) Objectif {
	if len(data) > 0 {
		return typedFrom[Objectif](e.Data(asMap(data[0])))
	}
	return typedFrom[Objectif](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Objectif (all fields
// optional at the wire level).
func (e *ObjectifEntity) MatchTyped(match ...Objectif) Objectif {
	if len(match) > 0 {
		return typedFrom[Objectif](e.Match(asMap(match[0])))
	}
	return typedFrom[Objectif](e.Match())
}
...
func (e *ObjectifEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ObjectifEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ObjectifEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ObjectifEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ObjectifEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ObjectifEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ObjectifRemoveMatch and returns an Objectif. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ObjectifEntity) RemoveTyped(reqmatch ObjectifRemoveMatch, ctrl map[string]any) (Objectif, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Objectif{}, err
	}
	return typedFrom[Objectif](res), nil
}



func (e *ObjectifEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
