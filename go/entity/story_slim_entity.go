...
func NewStorySlimEntity(client *core.ShortcutSDK, entopts map[string]any) *StorySlimEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StorySlimEntity) GetName() string { return e.name }
...
func (e *StorySlimEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StorySlimEntity) Deleted() bool {
	return e.deleted
}


func (e *StorySlimEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStorySlimEntity(e.client, opts)
}

func (e *StorySlimEntity) Data(args ...any) any {
...
func (e *StorySlimEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StorySlim; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StorySlimEntity) DataTyped(data ...StorySlim) StorySlim {
	if len(data) > 0 {
		return typedFrom[StorySlim](e.Data(asMap(data[0])))
	}
	return typedFrom[StorySlim](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StorySlim (all fields
// optional at the wire level).
func (e *StorySlimEntity) MatchTyped(match ...StorySlim) StorySlim {
	if len(match) > 0 {
		return typedFrom[StorySlim](e.Match(asMap(match[0])))
	}
	return typedFrom[StorySlim](e.Match())
}
...
func (e *StorySlimEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StorySlimEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *StorySlimEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *StorySlimEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StorySlimCreateData and returns an StorySlim. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StorySlimEntity) CreateTyped(reqdata StorySlimCreateData, ctrl map[string]any) (StorySlim, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return StorySlim{}, err
	}
	return typedFrom[StorySlim](res), nil
}




func (e *StorySlimEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// StorySlimUpdateData and returns an StorySlim. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *StorySlimEntity) UpdateTyped(reqdata StorySlimUpdateData, ctrl map[string]any) (StorySlim, error) {
...
func (e *StorySlimEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StorySlimEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
