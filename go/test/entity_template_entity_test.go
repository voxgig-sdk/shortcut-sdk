...
func TestEntityTemplateEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		entityTemplateRef01Data := core.ToMapAny(vs.GetProp(
			vs.GetPath([]any{"new", "entity_template"}, setup.data), "entity_template_ref01"))

		entityTemplateRef01DataResult, err := entityTemplateRef01Ent.Create(entityTemplateRef01Data, nil)
		if err != nil {
			t.Fatalf("create failed: %v", err)
		}
		entityTemplateRef01Data = core.ToMapAny(entityTemplateRef01DataResult)
		...
		entityTemplateRef01ResdataUp0 := core.ToMapAny(entityTemplateRef01ResdataUp0Result)
		...
		entityTemplateRef01DataDt0LoadResult := core.ToMapAny(entityTemplateRef01DataDt0Loaded)
