...
func TestEnableEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		enableRef01ResdataUp0 := core.ToMapAny(entityData(enableRef01ResdataUp0Result))
...
func enableBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SHORTCUT_TEST_ENABLE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SHORTCUT_TEST_ENABLE_ENTID"])
