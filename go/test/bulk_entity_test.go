...
func TestBulkEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set SHORTCUT_TEST_BULK_ENTID JSON to run live")
			return
		}
...
func bulkBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SHORTCUT_TEST_BULK_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SHORTCUT_TEST_BULK_ENTID"])
